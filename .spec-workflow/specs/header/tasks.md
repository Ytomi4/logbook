...
- [x] 2. UserMenu の User interface 確認
  - File: src/components/common/UserMenu.tsx
...
- [x] 6. UserMenu の Storybook Stories 作成
...
- [x] 7. UserInfo の Storybook Stories 作成
...
- [x] 8. Layout ヘッダー部分の Storybook Stories 作成
